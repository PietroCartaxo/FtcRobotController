...
@TeleOp()
public class MotorNoEn extends LinearOpMode {
    private DcMotor motorNoEn;
    ...
    public void runOpMode() {
        motorNoEn = hardwareMap.get(DcMotor.class, "MotorEn");
...
//
//            while (opModeIsActive()){
//                motorNoEn.setPower(gamepad1.right_trigger);
//                telemetry.addData("Motor Power", motorNoEn.getPower());
//                telemetry.update();
